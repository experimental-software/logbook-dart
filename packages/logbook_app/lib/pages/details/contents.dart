...
class DetailsPageContents extends StatefulWidget {
  final LogEntry logEntry;

  const DetailsPageContents({
    Key? key,
    required this.logEntry,
  }) : super(key: key);

  @override
  State<DetailsPageContents> createState() => _DetailsPageContentsState();
}

class _DetailsPageContentsState extends State<DetailsPageContents> {
